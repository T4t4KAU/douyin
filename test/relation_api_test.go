...
func TestRelationFollowList(t *testing.T) {
	url := serverAddr + "/douyin/relation/follow/list/?user_id=1002&token=" + userToken
	method := "GET"
...
func TestRelationFollowerList(t *testing.T) {
	url := serverAddr + "/douyin/relation/follower/list/?user_id=1001&token=" + userToken
	method := "GET"
...
func TestRelationFriendList(t *testing.T) {
	url := serverAddr + "/douyin/relation/friend/list/?user_id=1001&token=" + userToken
	method := "GET"
