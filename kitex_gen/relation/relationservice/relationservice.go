...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"RelationCount":        kitex.NewMethodInfo(relationCountHandler, newRelationServiceRelationCountArgs, newRelationServiceRelationCountResult, false),
...
func relationCountHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*relation.RelationServiceRelationCountArgs)
	realResult := result.(*relation.RelationServiceRelationCountResult)
	success, err := handler.(relation.RelationService).RelationCount(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newRelationServiceRelationCountArgs() interface{} {
	return relation.NewRelationServiceRelationCountArgs()
}

func newRelationServiceRelationCountResult() interface{} {
	return relation.NewRelationServiceRelationCountResult()
}
...
func relationExistHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(relation.RelationService).RelationExist(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func (p *kClient) RelationCount(ctx context.Context, req *relation.RelationCountRequest) (r *relation.RelationCountResponse, err error) {
	var _args relation.RelationServiceRelationCountArgs
	_args.Req = req
	var _result relation.RelationServiceRelationCountResult
	if err = p.c.Call(ctx, "RelationCount", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) RelationExist(ctx context.Context, req *relation.RelationExistRequest) (r *relation.RelationExistResponse, err error) {
